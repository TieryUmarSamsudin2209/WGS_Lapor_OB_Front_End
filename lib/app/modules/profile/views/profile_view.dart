...
class _ProfileViewState extends State<ProfileView> {
  ...
  Widget build(BuildContext context) {
    ...
    final double headerHeight = (widget.showAppBar ?? false) ? 64.0 : 140.0;
      ...
      SingleChildScrollView(
        child: Stack(
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      const SizedBox(height: 56), // Spacing for the overlapping avatar (reduced)
            ...
            Positioned(
              top: headerHeight - 54, // headerHeight - 54 (radius + border)
              child: Container(
                decoration: BoxDecoration(
...
class EditProfileDialog {
  static Future<void> show(
    ...
    String? firstName,
    String? lastName,
    required void Function(String newFirstName, String newLastName) onSave,
    required void Function(String newAvatarPath) onAvatarChanged,
  }) async {
    final _firstController = TextEditingController(text: firstName ?? '');
    final _lastController = TextEditingController(text: lastName ?? '');
    final _avatarController = TextEditingController(text: avatarUrl ?? '');
    ...
    await showDialog(
      ...
      builder: (ctx) => AlertDialog(
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Avatar URL / path'),
              ),
              const SizedBox(height: 8),
              TextButton(
                onPressed: () {
                  // Propagate avatar change from the field
                  onAvatarChanged(_avatarController.text);
                },
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              onSave(_firstController.text.trim(), _lastController.text.trim());
...
class LogoutConfirmationDialog {
  static Future<void> show(BuildContext context, {required VoidCallback onConfirm}) async {
    await showDialog(
      context: context,
